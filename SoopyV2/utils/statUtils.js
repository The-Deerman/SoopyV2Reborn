...
let constants = {
    ...
    pet_items: {
        PET_ITEM_ALL_SKILLS_BOOST_COMMON: {
            description: "\xA77Gives +\xA7a10% \xA77pet exp for all skills",
            xpBoost: 0.1,
            xpBoostType: "all"
        },
        PET_ITEM_BIG_TEETH_COMMON: {
            description: "\xA77Increases \xA79Crit Chance \xA77by \xA7a5%",
            stats: {
                crit_chance: 5
            },
            xpBoost: 0,
        ...
        PET_ITEM_IRON_CLAWS_COMMON: {
            description: "\xA77Increases the pet's \xA79Crit Damage \xA77by \xA7a40% \xA77and \xA79Crit Chance \xA77by \xA7a40%",
            xpBoost: 0,
            xpBoostType: "all"
        },
        PET_ITEM_SHARPENED_CLAWS_UNCOMMON: {
            description: "\xA77Increases \xA79Crit Damage \xA77by \xA7a15%",
            stats: {
                crit_damage: 15
            },
            xpBoost: 0,
        ...
        PET_ITEM_HARDENED_SCALES_UNCOMMON: {
            description: "\xA77Increases \xA7aDefense \xA77by \xA7a25",
            stats: {
                defense: 25
            },
            xpBoost: 0,
        ...
        PET_ITEM_BUBBLEGUM: {
            description: "\xA77Your pet fuses its power with placed \xA7aOrbs \xA77to give them \xA7a2x \xA77duration",
            xpBoost: 0,
            xpBoostType: "all"
        },
        PET_ITEM_LUCKY_CLOVER: {
            description: "\xA77Increases \xA7bMagic Find \xA77by \xA7a7",
            stats: {
                magic_find: 7
            },
            xpBoost: 0,
        ...
        PET_ITEM_TEXTBOOK: {
            description: "\xA77Increases the pet's \xA7bIntelligence \xA77by \xA7a100%",
            xpBoost: 0,
            xpBoostType: "all"
        },
        PET_ITEM_SADDLE: {
            description: "\xA77Increase horse speed by \xA7a50% \xA77 and jump boost by \xA7a100%",
            xpBoost: 0,
            xpBoostType: "all"
        },
        PET_ITEM_EXP_SHARE: {
            description: "\xA77While unequipped this pet gains \xA7a25% \xA77of the equipped pet's xp, this is \xA77split between all pets holding the item.",
            xpBoost: 0,
            xpBoostType: "all"
        },
        PET_ITEM_TIER_BOOST: {
            description: "\xA77Boosts the \xA7ararity \xA77of your pet by 1 tier!",
            xpBoost: 0,
            xpBoostType: "all"
        },
        PET_ITEM_COMBAT_SKILL_BOOST_COMMON: {
            description: "\xA77Gives +\xA7a20% \xA77pet exp for Combat",
            xpBoost: 0.2,
            xpBoostType: "combat"
        },
        PET_ITEM_COMBAT_SKILL_BOOST_UNCOMMON: {
            description: "\xA77Gives +\xA7a30% \xA77pet exp for Combat",
            xpBoost: 0.3,
            xpBoostType: "combat"
        },
        PET_ITEM_COMBAT_SKILL_BOOST_RARE: {
            description: "\xA77Gives +\xA7a40% \xA77pet exp for Combat",
            xpBoost: 0.4,
            xpBoostType: "combat"
        },
        PET_ITEM_COMBAT_SKILL_BOOST_EPIC: {
            description: "\xA77Gives +\xA7a50% \xA77pet exp for Combat",
            xpBoost: 0.5,
            xpBoostType: "combat"
        },
        PET_ITEM_FISHING_SKILL_BOOST_COMMON: {
            description: "\xA77Gives +\xA7a20% \xA77pet exp for Fishing",
            xpBoost: 0.2,
            xpBoostType: "fishing"
        },
        PET_ITEM_FISHING_SKILL_BOOST_UNCOMMON: {
            description: "\xA77Gives +\xA7a30% \xA77pet exp for Fishing",
            xpBoost: 0.3,
            xpBoostType: "fishing"
        },
        PET_ITEM_FISHING_SKILL_BOOST_RARE: {
            description: "\xA77Gives +\xA7a40% \xA77pet exp for Fishing",
            xpBoost: 0.4,
            xpBoostType: "fishing"
        },
        PET_ITEM_FISHING_SKILL_BOOST_EPIC: {
            description: "\xA77Gives +\xA7a50% \xA77pet exp for Fishing",
            xpBoost: 0.5,
            xpBoostType: "fishing"
        },
        PET_ITEM_FORAGING_SKILL_BOOST_COMMON: {
            description: "\xA77Gives +\xA7a20% \xA77pet exp for Foraging",
            xpBoost: 0.2,
            xpBoostType: "foraging"
        },
        PET_ITEM_FORAGING_SKILL_BOOST_UNCOMMON: {
            description: "\xA77Gives +\xA7a30% \xA77pet exp for Foraging",
            xpBoost: 0.3,
            xpBoostType: "foraging"
        },
        PET_ITEM_FORAGING_SKILL_BOOST_RARE: {
            description: "\xA77Gives +\xA7a40% \xA77pet exp for Foraging",
            xpBoost: 0.4,
            xpBoostType: "foraging"
        },
        PET_ITEM_FORAGING_SKILL_BOOST_EPIC: {
            description: "\xA77Gives +\xA7a50% \xA77pet exp for Foraging",
            xpBoost: 0.5,
            xpBoostType: "foraging"
        },
        PET_ITEM_MINING_SKILL_BOOST_COMMON: {
            description: "\xA77Gives +\xA7a20% \xA77pet exp for Mining",
            xpBoost: 0.2,
            xpBoostType: "mining"
        },
        PET_ITEM_MINING_SKILL_BOOST_UNCOMMON: {
            description: "\xA77Gives +\xA7a30% \xA77pet exp for Mining",
            xpBoost: 0.3,
            xpBoostType: "mining"
        },
        PET_ITEM_MINING_SKILL_BOOST_RARE: {
            description: "\xA77Gives +\xA7a40% \xA77pet exp for Mining",
            xpBoost: 0.4,
            xpBoostType: "mining"
        },
        PET_ITEM_MINING_SKILL_BOOST_EPIC: {
            description: "\xA77Gives +\xA7a50% \xA77pet exp for Mining",
            xpBoost: 0.5,
            xpBoostType: "mining"
        },
        PET_ITEM_FARMING_SKILL_BOOST_COMMON: {
            description: "\xA77Gives +\xA7a20% \xA77pet exp for Farming",
            xpBoost: 0.2,
            xpBoostType: "farming"
        },
        PET_ITEM_FARMING_SKILL_BOOST_UNCOMMON: {
            description: "\xA77Gives +\xA7a30% \xA77pet exp for Farming",
            xpBoost: 0.3,
            xpBoostType: "farming"
        },
        PET_ITEM_FARMING_SKILL_BOOST_RARE: {
            description: "\xA77Gives +\xA7a40% \xA77pet exp for Farming",
            xpBoost: 0.4,
            xpBoostType: "farming"
        },
        PET_ITEM_FARMING_SKILL_BOOST_EPIC: {
            description: "\xA77Gives +\xA7a50% \xA77pet exp for Farming",
            xpBoost: 0.5,
            xpBoostType: "farming"
        }
    }
...
function calcSlayerWeight(type, experience) {
    ...
    if (!experience || experience <= 1000000) {
        return {
            weight: !experience ? 0 : experience / slayerWeight.divider,
            weight_overflow: 0
        };
    }
