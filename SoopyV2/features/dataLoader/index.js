...
loadApi(){return Promise.resolve().then(()=>{return(
fetch("https://soopy.dev/api/v2/player_skyblock/"+Player.getUUID().replace(/-/g,"")).json())}).then((_resp)=>{let data=_resp;
