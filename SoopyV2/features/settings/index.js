...
class EditLocationsPage extends GuiPage {
    ...
    clicked(mouseX, mouseY) {
        for (let setting of locationSettingHolder.getData()) {
            if (setting.clicked(mouseX, mouseY)) return;
        }
    }
...
class SettingPage extends GuiPage {
    constructor() {
        ...
        let settingsCategoryTitle = new SoopyTextElement().setText("\xA70Settings").setMaxTextScale(3).setLocation(0.1, 0.05, 0.5, 0.1);
