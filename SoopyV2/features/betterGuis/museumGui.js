...
class MuseumGui {
    constructor() {
        ...
        this.weaponText = new SoopyTextElement().setText("\xA75Weapons").setMaxTextScale(10).setLocation(0.1, 0.05, 0.8, 0.3);
        this.weaponsIndicator.addChild(this.weaponText);
        this.weaponsPercentageText = new SoopyTextElement().setLocation(0.1, 0.4, 0.8, 0.2).setText("\xA70Items Donated: \xA77Loading...").setMaxTextScale(10);
        ...
        this.armourText = new SoopyTextElement().setText("\xA75Armor Sets").setMaxTextScale(10).setLocation(0.1, 0.05, 0.8, 0.3);
        this.armourIndicator.addChild(this.armourText);
        this.armourPercentageText = new SoopyTextElement().setLocation(0.1, 0.4, 0.8, 0.2).setText("\xA70Items Donated: \xA77Loading...").setMaxTextScale(10);
        ...
        this.raritiesText = new SoopyTextElement().setText("\xA75Rarities").setMaxTextScale(10).setLocation(0.1, 0.05, 0.8, 0.3);
        this.raritiesIndicator.addChild(this.raritiesText);
        this.raritiesPercentageText = new SoopyTextElement().setLocation(0.1, 0.4, 0.8, 0.2).setText("\xA70Items Donated: \xA77Loading...").setMaxTextScale(10);
        ...
        this.specialText = new SoopyTextElement().setText("\xA75Special Items").setMaxTextScale(10).setLocation(0.1, 0.05, 0.8, 0.3);
        this.specialIndicator.addChild(this.specialText);
        this.specialPercentageText = new SoopyTextElement().setLocation(0.1, 0.4, 0.8, 0.6).setText("\xA70Items Donated: \xA77Loading...").setMaxTextScale(10);
        ...
        this.pageTitle = new SoopyTextElement().setText("\xA75Your Museum").setMaxTextScale(10).setLocation(0, 0, 1, 1);
        ...
        this.nextButton = new ButtonWithArrow().setLocation(0.5 + widthPer * 3 / 2 - widthPer / 2, 0.25, widthPer / 2, 0.075).setText("\xA70Next Page");
        ...
        this.previousButton = new ButtonWithArrow().setLocation(0.5 - widthPer * 3 / 2, 0.25, widthPer / 2, 0.075).setText("\xA70Previous Page").setDirectionRight(false);
        ...
        let donateTitle = new SoopyTextElement().setText("\xA75Donate").setMaxTextScale(10).setLocation(0, 0, 1, 1);
        ...
        let favoriteTitle = new SoopyTextElement().setText("\xA75Favourite Items").setMaxTextScale(10).setLocation(0, 0, 1, 1);
    ...
    tickMenu(first = false) {
        ...
        if (Player.getContainer().getName() === "Your Museum") {
            ...
            lore.forEach((line, i) => {
                ...
                if (line.split(" ")?.[1]?.includes("/")) {
                    ...
                    this.weaponsPercentageText.setText("\xA70Items Donated: \xA77" + data[0] + "/" + data[1]);
                }
            });
            ...
            lore.forEach((line, i) => {
                ...
                if (line.split(" ")?.[1]?.includes("/")) {
                    ...
                    this.armourPercentageText.setText("\xA70Items Donated: \xA77" + data[0] + "/" + data[1]);
                }
            });
            ...
            lore.forEach((line, i) => {
                ...
                if (line.split(" ")?.[1]?.includes("/")) {
                    ...
                    this.raritiesPercentageText.setText("\xA70Items Donated: \xA77" + data[0] + "/" + data[1]);
                }
            });
            ...
            lore.forEach((line, i) => {
                ...
                if (ChatLib.removeFormatting(line).startsWith("Items Donated: ")) {
                    this.specialPercentageText.setText("\xA70Items Donated: \xA77" + ChatLib.removeFormatting(line).split(": ")[1]);
                }
            });
            this.specialIndicator.setLore(lore);

            if ((this.pageTitle.text !== "\xA75" + Player.getContainer().getName() || first) && !this.searchText) {
                this.itemsBox.clearChildren();
                let rewardsButton = new ButtonWithArrow().setText("\xA75Rewards").setLocation(0.1, 0.05, 0.8, 0.2);
                ...
                let browserButton = new ButtonWithArrow().setText("\xA75Museum Browser").setLocation(0.1, 0.3, 0.8, 0.2);
        ...
        if (itempages.includes(this.replacePage[Player.getContainer().getName().split("\u279C").pop()])) {
            ...
            for (let i = 0; i < 4; i++) {
                for (let j = 10; j < 17; j++) {
                    ...
                    } else if (this.itemsInPages[page][currPage][slot]) {
        ...
        if (Player.getContainer().getName() === "Confirm Donation") {
            let this_confirm_temp_str = (Player.getContainer().getStackInSlot(4)?.getName() || "") + (Player.getContainer().getStackInSlot(2)?.getName() || "") + (Player.getContainer().getStackInSlot(20)?.getName() || "") + (Player.getContainer().getStackInSlot(24)?.getName() || "");
            if (this.confirm_temp !== this_confirm_temp_str || first) {
                ...
                if (isArmour) {
                    ...
                    let itemBox = new BoxWithText().setText(name.startsWith("\xA7f") ? "&7" + name.substr(2) : name).setLocation(0.1, 0.05, 0.8, 0.2).setLore(getLore(Player.getContainer().getStackInSlot(2)));
                    this.itemsBox.addChild(itemBox);
                } else {
                    let name = Player.getContainer().getStackInSlot(4).getName();
                    let itemBox = new BoxWithText().setText(name.startsWith("\xA7f") ? "&7" + name.substr(2) : name).setLocation(0.1, 0.05, 0.8, 0.2).setLore(getLore(Player.getContainer().getStackInSlot(4)));
                    this.itemsBox.addChild(itemBox);
                }
                if (Player.getContainer().getStackInSlot(24) && Player.getContainer().getStackInSlot(20)) {
                    let cancelButton = new ButtonWithArrow().setText("\xA7cCancel").setLocation(0.1, 0.4, 0.35, 0.2).setDirectionRight(false).setLore(getLore(Player.getContainer().getStackInSlot(24)));
                    ...
                    let confirmButton = new ButtonWithArrow().setText("\xA7aConfirm Donation").setLocation(0.55, 0.4, 0.35, 0.2).setLore(getLore(Player.getContainer().getStackInSlot(20)));
        ...
        this.pageTitle.setText("\xA75" + Player.getContainer().getName());
    ...
    regenDonateItems() {
        ...
        this.donateItems.forEach((item, i) => {
            let itemButton = new ButtonWithArrow().setText(item.name.startsWith("\xA7f") ? "&7" + item.name.substr(2) : item.name).setLocation(0.05, 0.025 + 0.125 * i, 0.9, 0.1).setLore(item.lore);
    ...
    showSearchItems() {
        ...
        items.forEach((slot, slotNum) => {
            ...
            let child;
            if (slot.sb_id === "NA") {
                child = new BoxWithText().setText(slot.name.startsWith("\xA7f") ? "&7" + slot.name.substr(2) : slot.name).setLore(slot.lore);
                if (slot.name.startsWith("\xA7c")) {
                    child.setColor(255, 100, 100);
                    child.setText("&0" + slot.name.substr(2));
                }
                if (slot.name.startsWith("\xA7e")) {
                    child.setColor(255, 255, 100);
                    child.setText("&0" + slot.name.substr(2));
                }
            } else {
                let fItem = slot;
                child = new ButtonWithArrow().setText(slot.name.startsWith("\xA7f") ? "&7" + slot.name.substr(2) : slot.name).setLore(slot.lore);
                child.addEvent(new SoopyMouseClickEvent().setHandler((mouseX, mouseY, button) => {
                    ...
                    if (child.hovered) {
                        ...
                        if (this.replacePage[Player.getContainer().getName().split("\u279C").pop()] === fItem.page) {
                            clicks = pageClicks + 1 + "";
                        } else if (Player.getContainer().getName() === "Your Museum") {
        ...
        this.itemsInPages[page][page2].forEach((slot, slotNum) => {
            ...
            if (slot.sb_id === "NA") {
                ...
                child.addEvent(new SoopyMouseClickEvent().setHandler((mouseX, mouseY, button) => {
                    ...
                    Player.getContainer().click(slotNum, false, "LEFT");
                }));
                if (this.favoriteIds.includes(slot.sb_id)) {
                    child.setColor(200, 255, 200);
                }
    ...
    addItemToFavorites(slot, page, page2, slotNum) {
        if (page === "Special Items") {
            new Notification("\xA7cError!", ["You cant add Special Items", ["to favorites"]]);
            return;
        }
    ...
    updatedFavorites(saveToFile = true) {
        ...
        this.favoriteItems.forEach((fItem, i) => {
            let item = new ButtonWithArrow().setText(fItem.name.startsWith("\xA7f") ? "&7" + fItem.name.substr(2) : fItem.name).setLocation(0.05, 0.025 + 0.125 * i, 0.9, 0.1).setLore(fItem.lore);
    ...
    guiOpened(event) {
        ...
        if (this.isInMuseum) {
            ...
            if (name === "Your Museum" && !this.isInMuseum) {
                ...
                this.pageTitle.setText("\xA75" + name);
