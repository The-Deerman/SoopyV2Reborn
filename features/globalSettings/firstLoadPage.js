...
if(addBack){
let backButton=new ButtonWithArrow().setLocation(0.05,0.85,0.2,0.1).setDirectionRight(false).setText("\xA70Back");
...
if(addNext){
let nextButton=new ButtonWithArrow().setLocation(0.75,0.85,0.2,0.1).setText("\xA70Next");
