...
class SettingPage extends GuiPage {
    constructor() {
        ...
        let friendsTitle = new SoopyTextElement().setText("\xA70Friends").setMaxTextScale(3).setLocation(0.1, 0.05, 0.8, 0.1);
    ...
    runCommandsArray(commands, callback) {
        ...
        this.sidebarCustomPage.addChild(
            new ButtonWithArrow().setText("\xA70CANCEL!").setLocation(0.1, 0.2, 0.8, 0.1).
        ...
        this.sidebarCustomPage.addChild(new SoopyTextElement().setText("\xA70Running commands...").setLocation(0.2, 0.1, 0.6, 0.1).setMaxTextScale(10));
        ...
        for (let i = 0; i < commands.length; i++) {
            ...
            elements.push(new SoopyTextElement().setText("\xA70" + commands[i]).setLocation(0.2, 0.4 + i * 0.025, 0.6, 0.025));
    ...
    updateSidebar() {
        ...
        if (this.selectedFriends.size > 0) {
            this.sidebarMainPage.addChild(
                new SoopyTextElement().setText("\xA70" + this.selectedFriends.size + " friends selected").setMaxTextScale(2).setLocation(0.1, 0.05, 0.8, 0.1));

            this.sidebarMainPage.addChild(
                new ButtonWithArrow().setText("\xA70Deselect all").setLocation(0.1, 0.15, 0.8, 0.1).
                    addEvent(new SoopyMouseClickEvent().setHandler(() => {
            ...
            this.sidebarMainPage.addChild(
                new ButtonWithArrow().setText("\xA70Unfriend all").setLocation(0.1, 0.25, 0.8, 0.1).
                    addEvent(new SoopyMouseClickEvent().setHandler(() => {
                        let commands = [];
            ...
            if (!this.allFriendsLoaded) {
                this.sidebarMainPage.addChild(
                    new ButtonWithArrow().setText("\xA70Load all friends").setLocation(0.1, 0.1, 0.8, 0.15).
                        addEvent(new SoopyMouseClickEvent().setHandler(() => {
                            this.loadAllFriends();
                ...
                this.sidebarMainPage.addChild(
                    new ButtonWithArrow().setText("\xA70Select all").setLocation(0.1, 0.1, 0.8, 0.15).
                        addEvent(new SoopyMouseClickEvent().setHandler(() => {
